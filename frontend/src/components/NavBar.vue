            ...
            <VContainer fluid>
                    <VRow align="center" justify="center">
                        ...
                        <VCol cols="10"  align="center"   > 
                            ...
                            <!-- Add Links Below -->
                            <RouterLink class="route" to="/broadcast">
                                <VBtn class="text-subtitle-2" density="compact" color="primary" :variant="(route.name == 'Station')? 'tonal':'text'">Live Broadcast</VBtn>
                            </RouterLink>

                            <RouterLink class="route" to="/backcast">
                                <VBtn class="text-subtitle-2" density="compact" color="primary" :variant="(route.name == 'Backcast')? 'tonal':'text'">Backcast</VBtn>
                            </RouterLink>
