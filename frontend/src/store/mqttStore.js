...
export const useMqttStore =  defineStore('mqtt', ()=>{
    ...
    */ 
    ...
    const payload           = ref({"id":620162688,"timestamp": 1702566538,"temperature":0,"humidity":0,"heatindex":0,"pressure":0,"altitude":0,"moisture":0}); // Set initial values for payload
    const payloadTopic      = ref("");
    const subTopics         = ref({});
    let connectMqtt         = ref(false);
